...
const EditProfile = () => {
  ...
  return (
    <div className="min-h-screen bg-black text-white p-4">
      {/* Navbar */}
      <div className="flex justify-between items-center bg-blue-600 px-4 py-3 rounded-lg mb-6">
      ...
      <div className="max-w-4xl mx-auto bg-gray-300 p-6 rounded-xl shadow-lg flex flex-col md:flex-row gap-8">
        {/* Avatar Section */}
        ...
        <div className="flex-1 space-y-4">
          ...
          <div>
            ...
            <textarea
              ...
              value={form.bio}
              onChange={handleChange}
              className="w-full text-white p-2 rounded-lg ring-"
              rows="3"
            />
          </div>
