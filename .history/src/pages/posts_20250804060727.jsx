...
import PostCard from "../components/PostCard"; // ✅ your post card
import CommentsDrawer from "../components/CommentsDrawer"; // ✅ comment drawer
...
export default function Posts() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-r from-purple-600 to-pink-400 p-6 flex justify-center">
